...
const invoiceItemSchema = new mongoose.Schema({
  ...
  amount:      { type: Number, min: 0 },   // auto-filled = quantity * unitPrice
}, { _id: false });

const invoiceSchema = new mongoose.Schema({
  clinicId:      { type: ObjectId, ref: 'Clinic' },
  invoiceNumber: { type: String, unique: true },   // auto-generated, e.g. INV-2026-00001
...
// Auto: line totals, subtotal, grand total, pay status, invoice number
